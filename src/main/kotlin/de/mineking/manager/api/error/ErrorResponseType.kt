...
enum class ErrorResponseType(val status: HttpStatus) {
	...
	SKILL_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND),
	SKILL_GROUP_ALREADY_EXISTS(HttpStatus.CONFLICT),
	USER_NOT_FOUND(HttpStatus.NOT_FOUND),
	USER_ALREADY_EXISTS(HttpStatus.CONFLICT),
	INPUT_NOT_FOUND(HttpStatus.NOT_FOUND),
	INPUT_ALREADY_EXISTS(HttpStatus.CONFLICT),
